...
class State(str, Enum):
    ...
    ADM_ADD_INBOUND_DAYS = "adm_add_inbound_days"
    ...
    ADM_MGMT_ADD_INBOUND_ID = "adm_mgmt_add_inbound_id"
    ADM_MGMT_ADD_INBOUND_NAME = "adm_mgmt_add_inbound_name"
    ADM_MGMT_ADD_INBOUND_QUOTA = "adm_mgmt_add_inbound_quota"
    ADM_MGMT_ADD_INBOUND_DAYS = "adm_mgmt_add_inbound_days"

    ADM_MGMT_EDIT_NAME = "adm_mgmt_edit_name"
    ADM_MGMT_EDIT_QUOTA = "adm_mgmt_edit_quota"
    ADM_MGMT_EDIT_DAYS = "adm_mgmt_edit_days"
